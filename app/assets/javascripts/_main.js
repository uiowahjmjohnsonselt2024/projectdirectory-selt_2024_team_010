...
var cellColors = cellColorsHTML;
var gameId = gameIdHTML;
var currentCharacter = currentCharacterHTML
...
function updateTileInfoSection(data) {
    ...
    fetch(`/tiles/get_image?x=${data.x}&y=${data.y}`).then(response => {
        ...
        // Return a URL for the image blob
        ...
        let tileInfo = `
                ...
                <br>
                <p><strong>Picture:</strong> ${img_url ? "<img src='" + img_url + "' />" : "None"}</p>
                <br>
